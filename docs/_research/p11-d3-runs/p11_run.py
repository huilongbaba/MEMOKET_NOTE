"""P11 #1：文档意图接进 harness 之后，同一篇笔记、同一意图，智能续写「不带意图」和「带意图」各跑一次。

Usage: p11_run.py <note_id> <tag> [intent-text] [wall_budget_seconds]
...
S = Path("/private/tmp/claude-501/-Users-huilong-Skills-Bugfixing-Feishu/401a09f3-c80d-446c-a096-c81ed0fa949a/scratchpad/p11")
DATA = S / "p11data"
os.environ["KITE_DATA_DIR"] = str(DATA)
os.chdir(str(DATA))

WT = Path("/Users/huilong/Skills-Bugfixing-Feishu/MEMOKET_NOTE/.claude/worktrees/agent-ab7ff4604cbe04315/backend")
