"""P8 (same script as P6, only paths changed): run 智能续写 (note mode) once on one real note, on the scratch copy.
...
S = Path("/private/tmp/claude-501/-Users-huilong-Skills-Bugfixing-Feishu/401a09f3-c80d-446c-a096-c81ed0fa949a/scratchpad/p8")
DATA = S / "p8data"
