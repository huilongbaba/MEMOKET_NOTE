...
from app.harness.checks.grounding_rules import fact_usage, grounding_gap
...
def test_material_exhausted_stops_the_pointless_extra_rounds():
    ...
    """
    from app.harness.checks.grounding_rules import material_exhausted
...
def test_scrub_meta_sentences():
    ...
    from app.harness.checks.grounding_rules import scrub_meta_sentences
...
def test_bench_wordlist_and_scrubber_cannot_drift():
    ...
    from app.harness.checks.grounding_rules import _META_SENT, scrub_meta_sentences
